...
namespace NanoPBM {
    ...
    struct ChemicalReactionParameters {
        ...
        ChemicalReactionParameters(
            std::array<sunindextype, n_reactants> r_indices,
        ...
        std::array<sunrealtype, n_reactants> reactant_stoich,
                                        reactant_order;
        std::array<sunindextype, n_reactants> product_indices;
        std::array<sunrealtype, n_products> product_stoich,
                                       product_order;
    };
    ...
    class ChemicalReaction {
        ...
        const std::array<sunrealtype, n_reactants> reactant_stoich,
                                              reactant_order;
